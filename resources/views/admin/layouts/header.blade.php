    ...
    <ul class="nav user-menu">
        ...
        <li class="nav-item dropdown has-arrow main-drop">
            <a href="javascript:void(0);" class="dropdown-toggle nav-link userset" data-bs-toggle="dropdown">
                <span class="user-img">
                    @if(Auth::user()->avatar)
                        <img src="{{asset('frontend/images/profile/'.$user->avatar)}}" alt="">
                    @else
                        <img style="width:25px" src="{{ asset('admin/assets/img/icons/users1.svg')}}" alt="img">
                    @endif
            ...
            <div class="dropdown-menu menu-drop-user">
                <div class="profilename">
                    ...
                    <hr class="m-0">
                    <a class="dropdown-item logout pb-0" href="{{ route('logout') }}"><img src="{{ asset('admin/assets/img/icons/log-out.svg') }}" class="me-2" alt="img">Logout</a>
                </div>
            </div>
        </li>
    </ul>
